...
slurm_pre='--partition t4v2,t4v1,rtx6000 --gres gpu:1 --mem 40gb -c 4 --job-name cxr_sub --output /scratch/ssd001/home/haoran/projects/ClinicalDG/slurm_logs/cxr_sub_%A.log'
